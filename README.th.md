...
| `ctx_search` | FTS5 full-text search ในทุก output ที่เก็บไว้ (รองรับ `context_lines`). อักขระพิเศษ (`#`, `-`, `\|`, `:`, `*`) ถูก escape อัตโนมัติ ไม่ต้อง escape เอง; ถ้า FTS5 ล้มเหลวจะ fallback ไป LIKE scan. |
