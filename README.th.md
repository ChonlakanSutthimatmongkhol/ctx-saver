...
ถ้าติดตั้งผ่าน `go install` และไม่ได้ clone repository นี้ ให้ใช้ shallow clone ชั่วคราวเพื่อเรียก script:
...
# ติดตั้ง hooks สำหรับ VS Code Copilot (ให้รันจาก project root ของคุณ)
